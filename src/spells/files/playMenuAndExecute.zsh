...
__vgh_dataGetter='fd -ip -t f --hidden --no-ignore'
__vgh_command='v'
...
__tiggh_dataGetter='fd -ip -t f --hidden --no-ignore'
__tiggh_command='tig'
...
__cdgh_dataGetter='fd -ip -t d --hidden --no-ignore'
__cdgh_command='cd'
